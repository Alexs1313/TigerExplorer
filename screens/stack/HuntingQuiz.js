...
import {quizHunting} from '../../data/quizHunting';
...
const HuntingQuiz = () => {
  ...
  const handleOptionPress = pressedOption => {
    if (currentQuestionIdx === quizHunting.length - 1) {
      navigation.goBack();
    } else {
      const isCorrectAnswer =
        quizHunting[currentQuestionIdx].answer === pressedOption;
